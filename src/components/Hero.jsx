...
/* ─── Removed old stagger config in favor of anime.stagger ─── */

const TRUST_STATS = [
  { value: 10,  suffix: '+', label: 'Tahun Pengalaman' },
  { value: 500, suffix: '+', label: 'Klien B2B' },
  { value: 4,   suffix: '',  label: 'Kategori Produk' },
]
        ...
        <div className={styles.content}>
          ...
          <StaggerItem>
            <div className={styles.badge}>
              ...
              Supplier Fitting Pipa Industri{' '}
              <span className={styles.goldText}>#1</span> di Jakarta
            </div>
          </StaggerItem>
          ...
          <StaggerItem>
            <h1 id="hero-heading" className={`display-lg ${styles.heading}`} itemProp="headline">
              Supplier{' '}
              <span className={styles.goldHighlight}>Fitting Pipa</span>
              <br />
              <span className={styles.headingAccent}>Industri di Jakarta</span>
            </h1>
          </StaggerItem>
          ...
          <StaggerItem>
            <p className={`body-lg ${styles.sub}`} itemProp="description">
              Menyediakan solusi perpipaan{' '}
              <span className={styles.goldText}>B2B &amp; B2C</span>{' '}
              berkualitas tinggi di seluruh Indonesia.
              <br className={styles.brDesktop} />
              Butt Welded, Seamless, dan Forged Fittings — dibuat untuk
              ketahanan, dirancang untuk efisiensi.
            </p>
          </StaggerItem>
          ...
          <StaggerItem>
            <div className={styles.ctas}>
              <a
                ...
                aria-label="Hubungi Fittings Jakarta via WhatsApp"
          ...
          <StaggerItem>
            <div className={styles.stats} role="list" aria-label="Statistik perusahaan">
              {TRUST_STATS.map(({ value, suffix, label }) => (
